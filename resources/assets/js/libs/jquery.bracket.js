...
(function ($) {
    ...
    var Score = /** @class */ (function (_super) {
        ...
        Score.of = function (val) {
            ...
            if (val !== null && type !== expected && type !== expected2) {
                throw new Error("Invalid score format, expected " + expected + " or " + expected2 + ", got " + type);
            }
    ...
    var MatchResult = /** @class */ (function () {
        ...
        MatchResult.teamsInResultOrder = function (match) {
            ...
            if (bBye && !aBye) {
                ...
                if (match.a.score.get() >= match.b.score.get()) {//Mark, Note: default winner is first team
                    return [match.a, match.b];
                }
