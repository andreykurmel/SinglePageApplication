<nav class="navbar fixed-top align-items-start navbar-expand-lg pl-0 pr-0 py-0" >
    ...
    <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand mr-0" href="{{ route('data') }}">
            <img src="{{ url('assets/img/TablDA_w_text.png') }}" height="35" alt="{{ settings('app_name') }}">
        </a>
    </div>
        ...
        <ul class="navbar-nav ml-auto pr-3">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right position-absolute" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="{{ route('profile') }}" target="_blank">
