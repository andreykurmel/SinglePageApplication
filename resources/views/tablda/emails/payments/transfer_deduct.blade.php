...
@section('email_content')
    <p style="{{ $styles['paragraph'] }}">@lang('app.transfer_deduction__thanks', ['domain' => config('app.url_domain')])</p>
    <p style="{{ $styles['paragraph'] }}">@lang('app.transfer_deduction__listing')</p>
    ...
    <table style="{{ $styles['table'] }}">
        ...
        <tr>
            <td style="{{ $styles['table--th'] }}">Credit Deducted</td>
        ...
        <tr>
            <td style="{{ $styles['table--th'] }}">Credit Receiver(s)</td>
            <td style="{{ $styles['table--td'] }}">
                @foreach($credit_receivers as $receiver)
                    <div>{{ $receiver }}</div>
                @endforeach
            </td>
        </tr>
