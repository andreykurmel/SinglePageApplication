...
return [
    ...
    'discourse_logout_url' => env('DISCOURSE_LOGOUT_URL', ''),
    ...
    'tablda' => [
        ...
        'apps_tb' => env('TABLDA_APPS_TB', 'correspondence_apps'),
        'tables_tb' => env('TABLDA_TABLES_TB', 'correspondence_tables'),
        'fields_tb' => env('TABLDA_FIELDS_TB', 'correspondence_fields'),

        'def_host' => env('DB_HOST', 'localhost'),
        'def_database' => env('DB_DATABASE', 'forge'),
        'def_username' => env('DB_USERNAME', 'forge'),
        'def_password' => env('DB_PASSWORD', ''),
    ],
    /*
    |--------------------------------------------------------------------------
    | Application Name
    ...
    */
    ...
    'domain' => env('SESSION_DOMAIN', '.vanguard.dev'),
    'url_domain' => env('APP_DOMAIN', '.vanguard.dev'),
