 ...
 * @property int|null $preview_listing_id
 ...
 * @property string $email_link_viewtype
...
class TableEmailAddonSetting extends Model
{
    ...
    protected $fillable = [
        ...
        'email_link_viewtype', // [table, vertical, list]
    ...
    public function _table_permissions() {
        return $this->belongsToMany(TablePermission::class, 'table_email_rights', 'table_email_id', 'table_permission_id')
            ->as('_right')
            ->withPivot(['id', 'table_email_id', 'table_permission_id', 'can_edit']);
    }
