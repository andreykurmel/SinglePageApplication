...
namespace Intervention\Image\Facades { 
    ...
    class Image {
        ...
        {
            return \Intervention\Image\ImageManager::imagick()->read($data);
        }
...
namespace Vanguard\Services\Auth\TwoFactor { 
    ...
    class Facade {
         ...
         * @static
         */
        public static function sendSmsToken($user)
        {
            return \Vanguard\Services\Auth\TwoFactor\Authy::sendSmsToken($user);
        }
