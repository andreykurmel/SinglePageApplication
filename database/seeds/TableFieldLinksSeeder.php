...
class TableFieldLinksSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->create('add_record_limit', 'Max. number of records allowed to be added via link', $table, $user, 'Integer');
        $this->create('link_preview_fields', 'Info panel fields upon mouseover', $table, $user, 'String', 0, '', 'M-Select', 3);
        $this->create('link_preview_show_flds', 'Show field(s)', $table, $user, 'Boolean');
