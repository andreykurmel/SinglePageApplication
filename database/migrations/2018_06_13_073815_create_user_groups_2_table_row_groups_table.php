...
class CreateUserGroups2TableRowGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_groups_2_table_row_groups', function (Blueprint $table) {
            ...
            $table->unique(['user_group_id', 'table_row_group_id'], 'user_groups_2_table_row_groups_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('user_groups_2_table_row_groups');
    }
}
