...
class CreatePlanFeaturesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('plan_features', function (Blueprint $table) {
            ...
            $table->unsignedInteger('unit_conversion')->nullable();
            $table->unsignedInteger('group_rows')->nullable();
            $table->unsignedInteger('group_columns')->nullable();
            $table->unsignedInteger('group_users')->nullable();
            $table->unsignedInteger('group_refs')->nullable();
            $table->unsignedInteger('link_type_record')->nullable();
            $table->unsignedInteger('link_type_table')->nullable();
            $table->unsignedInteger('link_type_local')->nullable();
